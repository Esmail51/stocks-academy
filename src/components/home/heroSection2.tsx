 ...
 text-black py-8 lg:pb-5 lg:pt-15 px-5 lg:px-24 z-10  ">
      ...
      <div className="container mx-auto relative z-20">
        ...
        <div className="mt-10 text-center">
          <a
            href="/courses"
            className="inline-block bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500  text-white font-semibold text-lg px-5 py-3 rounded-full shadow-lg hover:shadow-2xl transform transition duration-300 hover:scale-105"
          >
            Explore Courses
          </a>
        </div>
