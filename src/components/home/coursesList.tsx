    ...
    return (
        <section className="bg-gray-50 py-12 px-8 lg:px-24 ">
            <div className="text-start mb-12">
                ...
                <p className="text-gray-600 mt-4">
                    Students will learn in an interactive-style boardroom limited to 6 persons, where students will gain hands-on knowledge of diverse aspects of technical analysis, charting tools, understanding of indicators, broader markets, and risk management tools.
                </p>
            </div>
                ...
                {[
                    ...
                    >
                        ...
                        <div className="p-6 flex flex-col flex-grow  justify-between">
                            ...
                            <ReadMoreText content={packageItem.content} />
                            </div>
...
const ReadMoreText = ({ content }: { content: string }) => {
    ...
    return (
        <p className="text-sm text-gray-600 mt-4">
            {isContentLong && !isExpanded ? `${content.slice(0,100)}...` : content}
            {isContentLong && (
                <p
