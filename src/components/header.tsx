        ...
        <header className="w-full flex justify-between items-center absolute z-20">
            ...
            <nav>
                <ul className="flex text-white text-lg font-semibold">
                    ...
                    <li className="mx-4 cursor-pointer hover:underline">Courses</li>
            ...
            <div className="w-10 h-10  rounded-md flex items-center justify-center">
                {/* <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="100%" height="100%" viewBox="5.7 0 105.5 126.1" preserveAspectRatio="xMinYMax meet" data-hook="svg-icon-1" className="fill-Indigo-600">
                    ...
                    <text x="58.5" y="77" dy=".35em" text-anchor="middle" data-hook="items-count" className="text-white">0</text>
                </svg> */}
            </div>
        </header>
    );
