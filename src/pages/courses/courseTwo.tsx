      ...
      <div>
        ...
        <div className='flex flex-col lg:flex-row lg:gap-20 gap-5'>
          <div className='lg:w-1/2 w-full '>
            <img src={img1} alt='Classroom' className='w-full rounded-lg object-cover h-[410px]' />
          ...
          <div className='lg:w-1/2 w-full text-start'>
            ...
            <div className='mb-6 pt-2'>
              ...
              <div className=' text-start  text-gray-700'>
                <div>
                <p className='font-semibold'>Price: $ 249.00<span className='font-semibold text-xs'>+Tax</span></p>
