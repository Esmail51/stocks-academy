                ...
                <section className=' py-12 bg-gradient-to-r from-googleBlue-500 to-purple-900 '>
                    <div className='  gap-20 lg:mx-24 mx-5'>
                        ...
                        <div className='flex gap-10 justify-center items-center flex-col lg:flex-row    text-white'>
                            ...
                            <div className='p-5 w-[70%] xl:w-[50%]  text-start flex flex-col justify-between bg-gradient-to-r from-purple-600 to-googleBlue-500    rounded-xl hover:scale-105 transition' >
                                <div>
                                    <div>
                                    ...
                                    <p className='text-4xl mt-8 font-bold'>$669.99<span className='font-semibold text-sm'>+ Tax</span> </p>
                                    {/* <p className='text-2xl font-semibold' > </p> */}

                                </div>
                                <button className='bg-black text-white hover:bg-blue-300 mt-5'>Subscribe</button>
                            </div>
                            <div className='p-5 w-[70%] xl:w-[50%]  text-start flex flex-col justify-between bg-gradient-to-r from-purple-600 to-googleBlue-500 rounded-xl hover:scale-105 transition'>
                                <div>
                                    ...
                                    <p className='text-4xl mt-8 font-bold'>$1049.00<span className='font-semibold text-sm'>+ Tax</span></p>
