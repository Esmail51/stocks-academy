        ...
        <section className='   '>
            ...
            <div className='' >
                ...
                <div className='flex gap-10 justify-center items-center flex-col lg:flex-row  text-white'>
                    ...
                    <div className='p-5 lg:w-[300px] w-full text-start flex flex-col justify-between h-[400px] bg-purple-900 rounded-xl hover:scale-105 transition' >
                        <div>
                        ...
                        <button className='bg-googleBlue-500 hover:bg-blue-300'>Subscribe</button>
                    </div>
                    <div className='p-5 lg:w-[300px] w-full text-start flex flex-col justify-between h-[400px] bg-purple-900 rounded-xl hover:scale-105 transition'>
                        <div>
